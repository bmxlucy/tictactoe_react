...
//   Передается из App.jsx, строка 234 (вычисляется функцией deriveWinner, строка 137)
// - onRestart: callback-функция для перезапуска игры
//   Передается из App.jsx, строка 234 (функция handleRestart из App.jsx, строка 177)
